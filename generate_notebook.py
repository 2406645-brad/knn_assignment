    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "3. **Optimal Hyperparameter**: The evaluation curve shows that $K$ values between $5$ and $11$ yield the best test sets accuracy (typically $\\sim 85\\%$ to $87\\%$ on this split), maintaining a good bias-variance trade-off without overfitting."
            ]
        }
    ],
    "metadata": {
...
print("[+] Generated notebook.ipynb successfully.")
